...
SUBJDIR="/lustre/scratch/wbic-beta/ccn30/ENCRYPT/images";
scriptdir=/lustre/scratch/wbic-beta/ccn30/ENCRYPT/scripts/ImagePrep/mp2rage
fsldir=/applications/fsl/fsl-5.0.10
mysubjs=/lustre/scratch/wbic-beta/ccn30/ENCRYPT/ENCRYPT_MasterRIScodes.txt
module load ANTS/2.2.0

for subj in `cat $mysubjs`
do 
