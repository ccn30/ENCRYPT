...
ASHSDir=/home/ccn30/rds/rds-p00500_encrypt-URQgmO1brZ0/p00500/ENCRYPT_ASHS_T2
ASHSmodule=/home/ccn30/privatemodules/ASHS/ashs-fastashs_beta
MagAtlasDir=/home/ccn30/rds/hpc-work/WBIC_home/ENCRYPT/atlases/magdeburgatlas
regDir=/home/ccn30/rds/rds-p00500_encrypt-URQgmO1brZ0/p00500/ENCRYPT_registrations

func=${scriptDir}/ASHS_mainfun.sh

workdir=$scriptDir/slurmoutputs

# child script takes subjIdx e.g. 0 and indexes $subjects in childscript 
CMD="$func $subjects $subjIdx $imageDir $ASHSDir $ASHSmodule $MagAtlasDir $workdir $regDir"
