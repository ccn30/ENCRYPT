#!/bin/bash
# corgeister templates/masks to subject image spaces
# also copies images
...
T1xTempAffine=${groupTempDir}/ants55template${subject}_t1*0GenericAffine.mat
T1xTempInvWarp=${groupTempDir}/ants55template${subject}_t1*1InverseWarp.nii.gz
T1xTempWarp=${groupTempDir}/ants55template${subject}_t1*1Warp.nii.gz
