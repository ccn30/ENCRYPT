#!/bin/bash
### SLURM submit array script ashsthk_docker.sh
#### running through singularity
### Created by M.O.Pope 27/7/21


#! This line is a comment
#! Make sure you only have comments and #SBATCH directives between here and the end of the #SBATCH directives, or things will break
#! Name of the job:
#SBATCH -J ashsthk-array
...
application="${scriptdir}/singularity_ashsthk_main.sh ${pathstem} ${index} ${workdir}"
