#!/bin/bash
### first create the SIF image in your chosen directory by running command in terminal (in chosen directory) "singularity pull docker://longxie/ashsthk:v3!"


#! This line is a comment
#! Make sure you only have comments and #SBATCH directives between here and the end of the #SBATCH directives, or things will break
#! Name of the job:
#SBATCH -J ashsthk-label-array
...
#! NOTE: This must be a range, not a single number (i.e. specifying '16' here would only run one job, with index 16)
#SBATCH --array=0-14
...
#module load /home/mp2011/privatemodules/ashs_tool
...
application="${scriptdir}/singularity_extract_label_thickness.sh ${pathstem} ${index} ${workdir}"
